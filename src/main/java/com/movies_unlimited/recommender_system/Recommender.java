...
public class Recommender {
    public static void main(String[] args) {
        ...
        movies.readFile("C:\\Users\\USER\\Desktop\\IT\\DATN\\movies_unlimited\\src\\main\\java\\com\\movies_unlimited\\data\\ml-data\\u.item");
        Users users = new Users();
        users.readFile("C:\\Users\\USER\\Desktop\\IT\\DATN\\movies_unlimited\\src\\main\\java\\com\\movies_unlimited\\data\\ml-data\\u.data");
        ...
        for (Map.Entry<Integer, Double> neighbourhood : neighbourhoods.entrySet()) {
            System.out.println("Item : " + neighbourhood.getKey() + " Count : " + neighbourhood.getValue());
        }
